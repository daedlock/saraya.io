 ...
 * The main module
 */
angular.module("hsApp").controller("MainCtrl", function($scope) {
  $scope.currentProject = {};
  $scope.loaded = false;
  var projects = [
    {
      ...
      description:
        "Unlock your social network to find tech jobs that you're directly connected to. With the largest tech jobs database in the world, save time looking for a job and never miss an opportunity again",
      role:
        "I was hired as the Lead UI/UX Designer and front-end developer. My responsibilites included creating UX wireframes and designing/developing responsive UI components.",
      ...
      techStack: {
        frontend: ["Bootstrap", "SASS", "AngularJS", "Modernizr"],
        backend: ["Rails", "AWS"]
      }
    },

    {
      ...
      url: "",
      description:
        "Sharpone Web Application is an internal product used by Sharp One Insurance Co. in Canada. The application is a Rich SPA relying completely on AngularJS.",
      role:
        "I was hired to design and develop the UI/UX for Sharp. The project was very interesting because it gave me the chance to dive deeper into AngularJS",
      ...
      techStack: {
        frontend: ["Bootstrap", "SASS", "AngularJS", "Modernizr", "Grunt"],
...

    {
      ...
      url: "http://ovio.eu",
      description:
        "An elite  European restaurant/café. The project involved creating a full-fledged Web Application and Admin Backend for the restaurant.",
      role:
        "I worked on the frontend implementation. The most fun thing was creating the masonry layout.",
...

    {
      ...
      url: "http://nassya.com",
      description:
        "Nassya is an Egyptian social network that connects you with people in your neighborhood.",
      role:
        "I worked in a medium sized team mainly as a Frontend and iOS Developer. I worked on the Web application, Mobile website and the iOS Application.",
...

    {
      ...
      role:
        "I am the Co-Founder of the app. I also developed everything from the ground up starting from the RESTful API Backend, the Administration Backend and the iOS App itself. I also designed the UX/UI.",
...

    {
      ...
      url: "",
      description:
        "Komodo is a mobile client for Oracle EBS (E-business Suite). The app targets business users and corporates and it works as a mobile interface for HR tasks.",
      role: "UI/UX Design",
